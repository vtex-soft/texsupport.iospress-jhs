...
- `jhs_template.tex` - the main template file should be used for article preparation;
...
- `jhs_template.bbl` is a sample bibliography file created by BibTeX using the `ios1.bst` file.
...
- Use the template file `jhs_template.tex` to prepare your manuscript.
